...
public class SplashAnimation : UIPanel
{
    ...
    public SplashAnimation(Rectangle bounds, Action onComplete)
    {
        _bounds = bounds;
        ...
        try
        {
            _lines = System.IO.File.ReadAllLines("Content/splash_text.txt");
        }
        catch
        {
            _lines = new[] { "LITHOS BIOS", "Boot Check <OK>", "Loading..." };
        }
