...
1. 3d Walking sim with puzzles integrated (3d game is the desktop background so apps can be open over it)
1. Proof of concept narrative elements
1. Deduction puzzle with alien language
1. Pinball
1. Solitaire
